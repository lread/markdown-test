== Emojis
This following line (`:brain: :dog: :cat: :duck:`) will be interpreted as an adoc custom document attribute:

:brain: :dog: :cat: :duck:

Here's its value: {brain}.

To suppress use `++++:brain:+ :dog: :cat: :duck:+++`

+:brain:+ :dog: :cat: :duck:

Or `+++pass:[:brain:] :dog: :cat: :duck:+++`

pass:[:brain:] :dog: :cat: :duck:
